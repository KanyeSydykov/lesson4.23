...
public class Main {
    ...
    public static int[] heroesHealth = {270, 260, 250, 240, 280, 400, 130};
    public static int[] heroesDamage = {25, 15, 20, 30, 0, 5, 15};
    public static String[] heroesAttackType = {
            "Physical", "Magical", "Kinetic", "Archer", "Medic", "Golem", "Magic"};
